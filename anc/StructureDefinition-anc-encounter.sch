...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Encounter">
      ...
      <sch:assert test="count(f:extension[@url = 'http://smart.who.int/anc/StructureDefinition/contactnumber']) &gt;= 1">extension with URL = 'http://smart.who.int/anc/StructureDefinition/contactnumber': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://smart.who.int/anc/StructureDefinition/contactnumber']) &lt;= 1">extension with URL = 'http://smart.who.int/anc/StructureDefinition/contactnumber': maximum cardinality of 'extension' is 1</sch:assert>
