# Resource RetrieveBusinessRulesFHIR
...
```json
{
  ...
  "extension" : [
    ...
    },
    {
      ...
      "valueUri" : "http://smart.who.int/trust/Requirements/RetrieveBusinessRulesFHIR"
    },
    {
    ...
    },
    {
      ...
      "valueString" : "Retrieve FHIR Business Rules"
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.title",
      "valueString" : "Retrieve HL7 FHIR compatible business rules"
    },
    {
    ...
    },
    {
      ...
      "valueMarkdown" : "Retrieve business rules from a distribution point using HL7 FHIR standards"
    },
    {
