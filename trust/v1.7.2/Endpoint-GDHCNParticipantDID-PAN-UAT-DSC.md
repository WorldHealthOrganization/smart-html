# GDHCNParticipantDID-PAN-UAT-DSC - WHO SMART Trust v1.7.2
...
**name**: Panama Trustlist (DID v2) - UAT - Document Signing Certificates did:web:tng-cdn.who.int:v2:trustlist:-:PAN:DSC resolvable at https://tng-cdn-uat.who.int/v2/trustlist/-/PAN/DSC/did.json
...
```json
{
  ...
  "id" : "GDHCNParticipantDID-PAN-UAT-DSC",
  "meta" : {
