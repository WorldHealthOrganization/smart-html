# GDHCNParticipantDID-PRY-UAT-DSC - WHO SMART Trust v1.7.2
...
**name**: Paraguay Trustlist (DID v2) - UAT - Document Signing Certificates did:web:tng-cdn.who.int:v2:trustlist:-:PRY:DSC resolvable at https://tng-cdn-uat.who.int/v2/trustlist/-/PRY/DSC/did.json
...
```json
{
  ...
  "id" : "GDHCNParticipantDID-PRY-UAT-DSC",
  "meta" : {
