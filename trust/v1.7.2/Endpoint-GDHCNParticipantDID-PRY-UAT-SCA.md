# GDHCNParticipantDID-PRY-UAT-SCA - WHO SMART Trust v1.7.2
...
**name**: Paraguay Trustlist (DID v2) - UAT - Certificate Signing Authority did:web:tng-cdn.who.int:v2:trustlist:-:PRY:SCA resolvable at https://tng-cdn-uat.who.int/v2/trustlist/-/PRY/SCA/did.json
...
```json
{
  ...
  "id" : "GDHCNParticipantDID-PRY-UAT-SCA",
  "meta" : {
