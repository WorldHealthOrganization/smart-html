# Resource RetrieveBusinessRulesCertLogic
...
```json
{
  ...
  "extension" : [
    ...
    },
    {
      ...
      "valueUri" : "http://smart.who.int/trust/Requirements/RetrieveBusinessRulesCertLogic"
    },
    {
    ...
    },
    {
      ...
      "valueString" : "Retrieve CertLogic Business Rules"
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.title",
      "valueString" : "Retrieve Cert Logic compatible business rules"
    },
    {
    ...
    },
    {
      ...
      "valueMarkdown" : "Retrieve Cert Logic business rules from a distribution point "
    },
    {
