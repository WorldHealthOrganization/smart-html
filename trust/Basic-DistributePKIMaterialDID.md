# Resource DistributePKIMaterialDID
...
```json
{
  ...
  "extension" : [
    ...
    },
    {
      ...
      "valueUri" : "http://smart.who.int/trust/Requirements/DistributePKIMaterialDID"
    },
    {
    ...
    },
    {
      ...
      "valueString" : "Distribute Public Keys as DID"
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.title",
      "valueString" : "Distribute PKI material as DID"
    },
    {
    ...
    },
    {
      ...
      "valueMarkdown" : "Make received trust material available through a distrubution point to a Trust Network Participant as DID"
    },
    {
