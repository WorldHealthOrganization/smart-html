# Resource PublishBusinessRulesCertLogic
...
```json
{
  ...
  "extension" : [
    ...
    },
    {
      ...
      "valueUri" : "http://smart.who.int/trust/Requirements/PublishBusinessRulesCertLogic"
    },
    {
    ...
    },
    {
      ...
      "valueString" : "Publish CertLogic Business Rules"
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.title",
      "valueString" : "Publish Cert Logic business rules"
    },
    {
    ...
    },
    {
      ...
      "valueMarkdown" : "Publish Cert Logic business rules to a Trust Anchor"
    },
    {
