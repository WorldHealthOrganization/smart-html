# Resource PublishPKIMaterialAPI
...
```json
{
  ...
  "extension" : [
    ...
    },
    {
      ...
      "valueUri" : "http://smart.who.int/trust/Requirements/PublishPKIMaterialAPI"
    },
    {
    ...
    },
    {
      ...
      "valueString" : "Publish Public Keys via API"
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.title",
      "valueString" : "Publish PKI material via API"
    },
    {
    ...
    },
    {
      ...
      "valueMarkdown" : "Publish trust material to a Trust Anchor via API"
    },
    {
