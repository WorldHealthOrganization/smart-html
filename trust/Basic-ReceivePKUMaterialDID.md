# Resource ReceivePKUMaterialDID
...
```json
{
  ...
  "extension" : [
    ...
    },
    {
      ...
      "valueUri" : "http://smart.who.int/trust/Requirements/ReceivePKUMaterialDID"
    },
    {
    ...
    },
    {
      ...
      "valueString" : "Receive Public Keys as DID"
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.title",
      "valueString" : "Receive PKI material as DID"
    },
    {
    ...
    },
    {
      ...
      "valueMarkdown" : "Receive trust material from a Trust Network Participant, for distribution within the Trust Network as DID"
    },
    {
