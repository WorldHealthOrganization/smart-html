# Resource ReceiveBusinessRulesFHIR
...
```json
{
  ...
  "extension" : [
    ...
    },
    {
      ...
      "valueUri" : "http://smart.who.int/trust/Requirements/ReceiveBusinessRulesFHIR"
    },
    {
    ...
    },
    {
      ...
      "valueString" : "Receive FHIR Business Rules"
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.title",
      "valueString" : "Receive HL7 FHIR business rules"
    },
    {
    ...
    },
    {
      ...
      "valueDateTime" : "2025-10-27T08:38:34+00:00"
    },
    {
    ...
    },
    {
      ...
      "valueMarkdown" : "Receive business rules from a Trust Network Participant, for distribution within the Trust Network using HL7 FHIR standard"
    },
    {
