# Resource RetrievePKIMaterialDID
...
```json
{
  ...
  "extension" : [
    ...
    },
    {
      ...
      "valueUri" : "http://smart.who.int/trust/Requirements/RetrievePKIMaterialDID"
    },
    {
    ...
    },
    {
      ...
      "valueString" : "Retrieve Public Keys as DID"
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.title",
      "valueString" : "Retrieve PKI material as DID"
    },
    {
    ...
    },
    {
      ...
      "valueMarkdown" : "Retrieve PKI material from a distribution point as DID"
    },
    {
