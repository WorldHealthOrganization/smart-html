# Resource RetrievePKIMaterialAPI
...
```json
{
  ...
  "extension" : [
    ...
    },
    {
      ...
      "valueUri" : "http://smart.who.int/trust/Requirements/RetrievePKIMaterialAPI"
    },
    {
    ...
    },
    {
      ...
      "valueString" : "Retrieve Public Keys via API"
    },
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-Requirements.title",
      "valueString" : "Retrieve PKI material via API"
    },
    {
    ...
    },
    {
      ...
      "valueMarkdown" : "Retrieve PKI material from a distribution point via API"
    },
    {
